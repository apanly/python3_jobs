...
class JobList(db.Model):
    ...
    command = db.Column(db.String(255, 'utf8mb4_general_ci'), nullable=False, info='命令')
    ...
    run_status = db.Column(db.Integer, nullable=False, server_default=db.FetchedValue(), info='运行状态：1 等待调度时间到来 2  运行中 3：一次性Job运行好了 ')
